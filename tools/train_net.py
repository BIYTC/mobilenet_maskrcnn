...
try:
    ...
    raise ImportError('Use APEX for multi-precision via apex.amp')  # 基于apex的混合精度加速
...
def main():
    ...
    with open(args.config_file, "r") as cf:  # 在参数解析时，参数中并不区分字符‘-’和‘_’
        config_str = "\n" + cf.read()
