...
class MaskRCNNC4Predictor(nn.Module):
    def __init__(self, cfg, in_channels):
        ...
        self.conv5_mask = ConvTranspose2d(num_inputs, dim_reduced, 2, 2, 0)  # 反卷积操作
        self.mask_fcn_logits = Conv2d(dim_reduced, num_classes, 1, 1, 0)  # 点卷积操作
...
def make_roi_mask_predictor(cfg, in_channels):
    func = registry.ROI_MASK_PREDICTOR[cfg.MODEL.ROI_MASK_HEAD.PREDICTOR]  # MaskRCNNC4Predictor
